...
namespace CatFactory.AspNetCore.Definitions.Extensions
{
    ...
    {
        public static ValidatorClassDefinition GetPostValidatorClassDefinition(this AspNetCoreProject project, ITable table)
        {
            var definition = new ValidatorClassDefinition
            {
                ...
                Name = project.GetPostValidatorName(table),
        ...
        public static ValidatorClassDefinition GetPutValidatorClassDefinition(this AspNetCoreProject project, ITable table)
        {
            var definition = new ValidatorClassDefinition
            {
                Namespaces =
                ...
                Namespace = project.GetValidatorsNamespace(),
                AccessModifier = AccessModifier.Public,
                Name = project.GetPutValidatorName(table),
                BaseClass = string.Format("AbstractValidator<{0}>", project.GetPutRequestName(table))
            };

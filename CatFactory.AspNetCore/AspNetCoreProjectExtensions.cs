...
namespace CatFactory.AspNetCore
{
    ...
    {
        public static AspNetCoreProject ScaffoldAspNetCore(this AspNetCoreProject aspNetCoreProject, bool useRepositories = false)
        {
            if (useRepositories)
                aspNetCoreProject.ScaffoldAspNetCoreUsingRepositories();
            else
                aspNetCoreProject.ScaffoldAspNetCoreUsingDomainDrivenDesign();

            return aspNetCoreProject;
        }

        internal static AspNetCoreProject ScaffoldAspNetCoreUsingDomainDrivenDesign(this AspNetCoreProject aspNetCoreProject)
        {
            aspNetCoreProject.ScaffoldRequestsUsingDomainDrivenDesign();
            aspNetCoreProject.ScaffoldRequestsExtensionsUsingDomainDrivenDesign();
            aspNetCoreProject.ScaffoldResponsesUsingDomainDrivenDesign();
            aspNetCoreProject.ScaffoldResponsesExtensionsUsingDomainDrivenDesign();

            foreach (var feature in aspNetCoreProject.Features)
            {
                aspNetCoreProject.Scaffold(feature.GetControllerClassDefinitionForDomainDrivenDesign(), aspNetCoreProject.OutputDirectory, aspNetCoreProject.AspNetCoreProjectNamespaces.Controllers);
            }

            aspNetCoreProject.ScaffoldMdReadMeUsingDomainDrivenDesign();

            return aspNetCoreProject;
        }

        internal static void ScaffoldRequestsUsingDomainDrivenDesign(this AspNetCoreProject project)
        {
        ...
        internal static void ScaffoldRequestsExtensionsUsingDomainDrivenDesign(this AspNetCoreProject project)
        {
            foreach (var table in project.Database.Tables)
            {
        ...
        internal static void ScaffoldResponsesUsingDomainDrivenDesign(this AspNetCoreProject project)
        {
        ...
        internal static void ScaffoldResponsesExtensionsUsingDomainDrivenDesign(this AspNetCoreProject project)
        {
        ...
        internal static void ScaffoldMdReadMeUsingDomainDrivenDesign(this AspNetCoreProject project)
        {
        ...
        internal static AspNetCoreProject ScaffoldAspNetCoreUsingRepositories(this AspNetCoreProject aspNetCoreProject)
        {
            ...
            aspNetCoreProject.ScaffoldResponsesUsingRepositories();
            aspNetCoreProject.ScaffoldResponsesExtensionsUsingRepositories();
            ...
            aspNetCoreProject.ScaffoldMdReadMeUsingRepositories();

            return aspNetCoreProject;
        }

        internal static void ScaffoldRequestsUsingRepositories(this AspNetCoreProject project)
        {
            foreach (var table in project.Database.Tables)
            {
                var getRequestClassDefinition = project.GetGetRequestClassDefinition(table);
        ...
        internal static void ScaffoldRequestsExtensionsUsingRepositories(this AspNetCoreProject project)
        {
            foreach (var table in project.Database.Tables)
            {
                var classDefinition = project.GetRequestExtensionsClassDefinition(table);
        ...
        internal static void ScaffoldResponsesUsingRepositories(this AspNetCoreProject project)
        {
            var interfaces = new List<CSharpInterfaceDefinition>
            {
                project.GetResponseInterfaceDefinition(),
        ...
        internal static void ScaffoldResponsesExtensionsUsingRepositories(this AspNetCoreProject project)
        {
            project.Scaffold(project.GetResponsesExtensionsClassDefinition(), project.OutputDirectory, project.AspNetCoreProjectNamespaces.Responses);
        }

        internal static void ScaffoldMdReadMeUsingRepositories(this AspNetCoreProject project)
        {
            var readMe = new MdDocument();
